...
def _verify_single_signature(root_element: etree._Element, signature_node: etree._Element) -> dict:
    ...
    if digest_valid:
        try:
            ...
            xpath_signing_time = './/ds:Object[@Id="TimeStamp"]/ds:SignatureProperties/ds:SignatureProperty/ds:SigningTime'
...
# --- CÁCH SỬ DỤNG ---
# HOADON_PATH = r"E:\Hwng\Projects\Invoice Tool\test\hoa_don_loi.xml"
